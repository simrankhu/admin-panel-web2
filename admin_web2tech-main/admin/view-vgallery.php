      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
           ...
           <h3>View Video Gallery</h3>
           </div>
           <a href="add-vgallery.php" class="btn btn-addnew">Add Video Gallery</a>               
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php   $query="SELECT * FROM vgallaery ORDER BY id DESC";
                ...
                <tr>
                  ...
                  <td>
                      <ul class="edit-button">
                          <li><a href="add-vgallery.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a></li>
...
<script>
  ...
  swal({   title: "Are you sure?", 
    text: "Want remove this Video Gallery", 
    type: "warning",  
    ...
    function(isConfirm){   
      if (isConfirm) {    
       $.ajax({
        ...
        data: {'id': ids ,'remove_vgallery':'action'} ,
        type: "POST",
        success: function (data) {
          if(data=='OK'){
            swal("Remove!", "Video Gallery has been removed", "success"); 
            location.reload();
          }
          else{
