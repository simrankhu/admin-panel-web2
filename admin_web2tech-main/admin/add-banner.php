...
if(isset($_POST['submit']) && $_POST['submit']=="add")
{
	...
	$query_duplicate="SELECT * FROM banner WHERE title='".$title."' $checkDuplicate";
	if($sql_duplicate=$conn->query($query_duplicate))
	{
		...
		else
		{
			if($id!="")
			{
				$query_update="UPDATE banner SET title='".$title."',status='".$status."',line1='".$line1."',line2='".$line2."',content='".$content."' WHERE id='".$id."'";
			...
			{
				$query_insert="INSERT INTO banner SET title='".$title."',status='".$status."',line1='".$line1."',line2='".$line2."',content='".$content."'";
...
if($id!="")
{
	...
	{ 
		...
		{
			echo "<script>document.location.href='view-banner.php';</script>";
			exit;
		}
    }
}
      ...
      <div class="row">
	   ...
	   <?php if($msg!="") { ?><h5 class="h5-headn" style="color:red;"><?php echo $msg; ?></h5><?php } else { ?>
          ...
          <div class="field-section">
              ...
              <div class="row">
               <div class="col-md-4">
                    <label class="input-text">Banner Title</label>
