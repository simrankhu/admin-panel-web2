      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
           ...
           <a href="add-mcenter.php" class="btn btn-addnew">Add Blog</a>               
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				        <?php   $query="SELECT * FROM mcenter ORDER BY id DESC";
                ...
                <tr>
                  ...
                  <td><img src="uploads/mcenter/<?php echo $row['image']; ?>" width="70px" height="70px" ></td>
                  <td>   <?php  if($row['status']=='1'){ echo "Enable";}else { echo "Disable";}   ?></td>
                  <td>
                      <ul class="edit-button">
                          <li><a href="add-mcenter.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a></li>
    ...
    function(isConfirm){   
      if (isConfirm) {    
       $.ajax({
        ...
        data: {'id': ids ,'remove_mcenter':'action'} ,
        type: "POST",
