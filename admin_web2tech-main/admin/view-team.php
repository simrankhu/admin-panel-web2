      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
           ...
           <h3>View Brand Logo</h3>
           </div>
           <a href="add-team.php" class="btn btn-addnew">Add Brand Logo</a>               
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>  
                <tr>
                  <td><img src="<?=$site_root?>/uploads/team/<?=$row['team_img']?>"  width="70px" height="70px"></td>
                  <td>   <?php  if($row['is_active']=='1'){ echo "Enable";}else { echo "Disable";}   ?></td>
                  <td>
                    <ul class="edit-button">
                      <li><a href="add-team.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a></li>
    ...
    function(isConfirm){   
      if (isConfirm) {    
       $.ajax({
        ...
        data: {'id': ids ,'remove_team':'action'} ,
        type: "POST",
