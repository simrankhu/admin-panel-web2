      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
           ...
           <a href="add-download.php" class="btn btn-addnew">Add Download</a>               
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php   $query="SELECT * FROM tbl_download ORDER BY id DESC";
                ...
                <tr>
                  ...
                  <td><img src="uploads/download/<?php echo $row['image']; ?>" width="70px" height="70px" ></td>
                  <td>   <?php  if($row['status']=='1'){ echo "Enable";}else { echo "Disable";}   ?></td>
                  <td>
                      <ul class="edit-button">
                          <li><a href="add-download.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a></li>
...
<script>
  ...
  swal({   title: "Are you sure?", 
    text: "Want remove this Download File", 
    type: "warning",  
    ...
    function(isConfirm){   
      if (isConfirm) {    
       $.ajax({
        ...
        data: {'id': ids ,'remove_download':'action'} ,
        type: "POST",
        success: function (data) {
          if(data=='OK'){
            swal("Remove!", "Download has been removed", "success"); 
            location.reload();
          }
          else{
