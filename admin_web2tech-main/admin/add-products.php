...
foreach($_FILES["hd_sl_image"]["tmp_name"] as $key=>$tmp_name){
	 ...
	 $filename=$_FILES["cat_pd_image"]['name'][$key];
    $ext = pathinfo($filename, PATHINFO_EXTENSION);
	$name =  $_FILES["hd_sl_image"]["name"][$key];
	$unid=random_string(2);
	 $hd_sl_image =  $time.$unid.'.'.$ext; 
...
$detires=mysqli_query($conn,"SELECT * FROM cat_prod Where id='$id'");
              ...
              <div class="row">
               <div class="col-md-4">
                <label class="input-text"> Name</label>
                 ...
                 <div class="col-md-4">
                <label class="input-text"> Authors Name</label>
                  <div class="form-group">
                ...
                <div class="col-md-4">
                <label class="input-text"> Keyword</label>
                  <div class="form-group">
                 ...
                 <div class="col-md-12">
                 <label class="input-text"> Meta Description</label>
                  <div class="form-group">
...
<!--                 <div class="col-md-4">
                <label class="input-text">Icon Image</label>
                  <div class="form-group">
					 ...
					 <div class="col-md-2">
                        <?php  if($fileName!=''){	?>
					  <img src="uploads/product/ic_image/<?php echo $fileName; ?>" width="50px" height="50px">
                ...
                <label class="input-text">Header Image</label>
                  <div class="form-group">
				    <?php 
					 ...
					 <div class="col-md-2">
                        <?php  if($fileName!=''){	?>
					  <img src="uploads/product/hd_image/<?php echo $fileName; ?>" width="50px" height="50px">
                ...
                <label class="input-text">Header Slider Image</label>
                  <div class="form-group">
					 ...
					 <div class="col-md-2">
                        <?php  if($fileName!=''){	?>
					  <img src="uploads/product/hd_sl_image/<?php echo $fileName; ?>" width="50px" height="50px">
          ...
          <input type="text" size="4" placeholder="Height" name="tmb_height" value="<?php echo $tmb_height; ?>">
                ...
                <label class="input-text">Cate/Prod Image</label>
                  <div class="form-group">
					 ...
					 <div class="col-md-2">
                        <?php  if($fileName!=''){	?>
					  <img src="uploads/product/cat_pd_image/<?php echo $fileName; ?>" width="50px" height="50px">
               ...
               <div class="col-md-3">
                <label class="input-text">Cate/Prod Hover Image</label>
                  <div class="form-group">
					 ...
					 <div class="col-md-2">
                        <?php  if($fileName!=''){	?>
					  <img src="uploads/product/cat_pd_hv_image/<?php echo $fileName; ?>" width="50px" height="50px">
             ...
             <div class="col-md-3">
                <label class="input-text">Cate/Prod Video</label>
                  <div class="form-group">
					 ...
					 <div class="col-md-2">
                        <?php  if($fileName!=''){	?>
					  <img src="uploads/product/cat_pd_pdf_image/pdf.png" width="50px" height="50px">
                ...
                <label class="input-text">Cate/Prod Video</label>
                  <div class="form-group">
				    <?php 
					 ...
					 <div class="col-md-2">
                        <?php  if($fileName!=''){	?>
					  <img src="uploads/product/cat_pd_video/<?php echo $fileName; ?>" width="50px" height="50px">
                ...
                <div class="col-row">
                  ...
                  <div class="form-group">
                      <label>MRP</label>
                      <input type="text" name="cat_pd_mrp" id="cat_pd_mrp"  value="<?php echo $cat_pd_mrp; ?>" class="from-control custom-type" placeholder="Cate/Prod MRP">
                   </div>
                  </div> 
                     <div class="col-md-2">
                  ...
                  <div class="form-group">
                      <label>PRICE</label>
                      <input type="text" name="cat_pd_price" id="cat_pd_price" value="<?php echo $cat_pd_price; ?>" class="from-control custom-type" placeholder="Cate/Prod Sell Price" >
                   </div>
                  </div> 
                     <div class="col-md-2">
                  ...
                  <div class="form-group">
                      ...
                      <select name="cat_pd_dist" class="from-control custom-type">
                          <?php
                          if($cat_pd_dist=='yes')
                          {
                          ?>
                  ...
                  <div class="form-group">
                      <label>Best Seller</label>
                        <select name="cat_pd_dist_amt" class="from-control custom-type">
                          <?php
                          if($cat_pd_dist=='yes')
                          {
                          ?>
                  ...
                  <div class="form-group">
                      <label>Featured</label>
                       <select name="cat_pd_sale_price" class="from-control custom-type">
                          <?php
                          if($cat_pd_dist=='yes')
                          {
                          ?>
                ...
                <label class="input-text">Minimum Sale Quantity</label>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                       <input tupe="text" name="stock" class="form-control custom-type" value="<?php echo $stock?>">
                ...
                <div class="col-md-12">
                 <label class="input-text"> Short Description</label>
                  <div class="form-group">
                      <textarea name="small_description" class="ckeditor" placeholder="Cate/Prod Small Description" rows="5" cols="5"><?php echo $small_description; ?></textarea>
                   </div>
                  </div>  
               ...
               <!--   <div class="col-md-12">
                 <label class="input-text">Days Free Returns / Exchange</label>
                  <div class="form-group">
                      <textarea name="free_return" id="free_return" class="ckeditor" class="from-control custom-type" placeholder="Page Description" rows="10" cols="80"><?php echo $free_return;?></textarea>
