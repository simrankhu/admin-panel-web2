      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
           ...
           <h3>View Home Service</h3>
           </div>
           <a href="add-h-page.php" class="btn btn-addnew">Add Service</a>               
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php   $query="SELECT * FROM tbl_home_ser ORDER BY id DESC";
                ...
                <tr>
                  ...
                  <td>
                      <ul class="edit-button">
                          <li><a href="add-h-page.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a></li>
