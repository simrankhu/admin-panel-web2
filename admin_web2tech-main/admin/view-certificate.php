      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
           ...
           <a href="add-certificate.php" class="btn btn-addnew">Add Certificate</a>               
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php   $query="SELECT * FROM tbl_certificates ORDER BY id DESC";
                ...
                <tr>
                  ...
                  <td><img src="uploads/certificate/<?php echo $row['image']; ?>" width="70px" height="70px" ></td>
                  <td>   <?php  if($row['status']=='1'){ echo "Enable";}else { echo "Disable";}   ?></td>
                  <td>
                      <ul class="edit-button">
                          <li><a href="add-certificate.php?id=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a></li>
...
<script>
  ...
  swal({   title: "Are you sure?", 
    text: "Want remove this Certificate", 
    type: "warning",  
    ...
    function(isConfirm){   
      if (isConfirm) {    
       $.ajax({
        ...
        data: {'id': ids ,'remove-certificate':'action'} ,
        type: "POST",
        success: function (data) {
          if(data=='OK'){
            swal("Remove!", "Certificate has been removed", "success"); 
            location.reload();
          }
          else{
